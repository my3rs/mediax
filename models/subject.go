...
type Subject struct {
	...
	SubjectType string `gorm:"size:16;index:idx_type_create_status,priority:1;index:idx_type_mark_status,priority:1;column:subject_type"`
	...
	Status      int    `gorm:"index:idx_type_create_status,priority:3;index:idx_type_mark_status,priority:3;column:status"`
	...
	CreatedAt   int64  `gorm:"index:idx_type_create_status,priority:2;column:created_at"`
