...
type Subject struct {
	...
	Status      int    `gorm:"index:idx_type_status_id,priority:2;index:idx_type_status_markdate,priority:2;column:status"`
	...
	MarkDate    string `gorm:"size:36;index:idx_type_status_markdate,priority:3;column:mark_date"`
